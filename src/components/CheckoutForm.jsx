...
const stripePromise = loadStripe('pk_test_51TwjrN6Hkdeo4canf8PcNir1UmEs1TfEDEyKRt00ku7XVjTDTtwFpNbWW82ukGU8oeR029mC2oyowGJgF6aslNEq00t3ZVwfFo');
...
export const CheckoutForm = ({ ventaActiva, setCurrentTab }) => {
    ...
    return (
      <div className="max-w-md mx-auto my-12 bg-white rounded-2xl p-8 border border-gray-100 text-center shadow-xl space-y-5 animate-fade-in-down">
        ...
        <div className="flex gap-3">
          <button
            onClick={() => setCurrentTab('cliente-panel')}
  ...
  return (
    <div className="max-w-md mx-auto my-12 bg-white rounded-3xl shadow-[0_20px_60px_-30px_rgba(112,33,18,0.8)] overflow-hidden border border-rose-100">
      <div className="bg-gradient-to-r from-rose-950 via-amber-900 to-amber-600 px-6 py-6 text-white text-center">
        <h2 className="text-xl font-bold">Checkout de Venta</h2>
        <p className="text-amber-100 mt-1 text-xs">Completa tu pago seguro para la orden #{ventaActiva.id}</p>
      </div>
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="space-y-3">
          ...
          <div className="bg-rose-50 p-4 rounded-xl border border-rose-100 text-sm space-y-2">
            ...
            <div className="border-t border-rose-200 pt-2 flex justify-between font-extrabold text-rose-950 text-sm">
