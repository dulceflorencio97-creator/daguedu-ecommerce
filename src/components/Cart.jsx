...
import {x,ShoppingBasket, Trasg2,Plus,Minus,CreditCard,Loader2} from 'ludice-react';

export const Cart = ({isOpen,onClose,cart,updateQuantity,removeFromCart,clearCart,
    setVistaActual,setVnetanaActiva}) => {
        ...
        const handleCheckout = async()=> {
             //mapeo de los datos ventana y detalle venta 
             const ventaPayload = {
             ...
             try {
                ...
                setVnetanaActiva(ventaRegistrada);
                clearCart();
                onclose();
                setClose();
